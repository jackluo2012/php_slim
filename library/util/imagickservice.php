...
class ImagickService {
	...
	public function init(){
 	...
 	//载入图像 path
	public function read_image($path) {
		try {
	...
	// upload stream 
	public function read_image_buff($buff){
		try {
	...
	*/
	...
	// return image buff
	public function get_images_blob()
	{
	...
	*/
     ...
     *   ImagickService::VerifCode($string);
     *   exit;
	 */
	public static function VerifCode($string){
		/*
